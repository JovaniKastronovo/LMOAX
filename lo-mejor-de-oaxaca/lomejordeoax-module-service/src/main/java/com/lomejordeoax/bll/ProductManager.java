...
public class ProductManager{
	...
	public int getNextProdutId()throws BusinessException{
		return productService.getNextProductId();		
	}
	
	public void saveNewProduct(Product newProduct,boolean addId)throws BusinessException{
		if(newProduct!=null){
