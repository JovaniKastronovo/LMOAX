...
public class SaleDaoImp extends HGenericDaoImp<Sale, Integer> implements SaleDao {
	...
	private static final String SALE_BY_STATUS_HQL = "from Sales s where s.sale_status_id = ?";
	...
	@Override
	public List<Sale> getSalesByStatus(Integer saleStatusId) throws DataException {
		List<?> result= getHibernateTemplate().find(SALE_BY_STATUS_HQL, saleStatusId);
